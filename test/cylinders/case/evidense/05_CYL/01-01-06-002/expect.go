	...
	for ix := minX; ix <= maxX; ix++ {
		...
		for jy := minY; jy <= maxY; jy++ {
			...
			for kz := minZ; kz <= maxZ; kz++ {
				...
				lensLon = math.Floor(lensLon*math.Pow10(6)) / math.Pow10(6)
				...
				lensLat = math.Floor(lensLat*math.Pow10(6)) / math.Pow10(6)
				...
				lensAlt = math.Floor(lensAlt*math.Pow10(6)) / math.Pow10(6)
